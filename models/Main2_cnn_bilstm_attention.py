...
from keras.layers import Input, Dense, LSTM ,Conv1D,Dropout,Bidirectional,Multiply,add,BatchNormalization
...
from keras.layers import Activation, Permute, Flatten, RepeatVector, Lambda
...
#m.save("./model.h5")
#np.save("normalize.npy",normalize)
name = 'result_cnn_bilstm_attention'
