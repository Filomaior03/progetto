...
# An alternative way of writing the attention mechanism that fits the above error message source :https://blog.csdn.net/uhauha2929/article/details/80733255
def attention_3d_block2(inputs, single_attention_vector=False):
    # If the previous layer is an LSTM, you need toreturn_sequences=True
    # inputs.shape = (batch_size, time_steps, input_dim)
